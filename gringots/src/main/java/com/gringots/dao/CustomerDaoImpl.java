...
/*        ResultSet tableKeys = preparedStatement.getGeneratedKeys();
    ...
    public CommonResponseDto createIndividual(String firstName, String lastName, String nic, String dob,int recordId) throws SQLException {
        ...
        Connection connection = dataSource.getConnection();
        PreparedStatement preparedStatement = connection.prepareStatement("insert into individual(first_name,last_name,nic,dob) values (?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
